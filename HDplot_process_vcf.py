...
'''
Modification by Ryan Zhao to support VCF4.1 format
'''
                ...
                if line.startswith('##'):
                    ...
                    if vcf_format == "VCFv4.1":
                        ...
                        for gen_idx, gen in enumerate(genotypes):
                            cell = gen.split(':')[0]
                            assert cell == '1/0' or cell == '0/1' or cell == '0/0' or cell == '1/1' or cell == './.'
                            if cell == './.':
                                num_samples -= 1
                        ...
                        for gen_idx, gen in enumerate(genotypes):
                            if gen.split(':')[0] in ['1/0', '0/1'] and gen.split(':')[1] != '.': # if het
                                depth_a_of_ind[inds[gen_idx]] = int(gen.split(':')[1].split(',')[0])
                                depth_b_of_ind[inds[gen_idx]] = int(gen.split(':')[1].split(',')[1])
